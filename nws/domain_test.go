...
// HTTP behaviour is covered in nws_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "nws://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("nws", "about")
	if err != nil || got.String() != "nws://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want nws://page/about", got.String(), err)
	}
}

...
Most of these come down to network reality or how nws serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nws rate-limits like any public site. nws already paces
...
Where a surface is gated, nws reads a cookie or token you supply
...
`nws`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nws actually did
